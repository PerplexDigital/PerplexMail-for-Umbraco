    ...
    public class EmailWorkflow : WorkflowType
    {
        ...
        public override WorkflowExecutionStatus Execute(Record record, RecordEventArgs e)
        {
            ...
            emailTags.AddRange(new[] 
            {
                ...
                // record.Id is only initialized when you enable Post Moderation              
                new EmailTag("[#recordId#]", record.Id.ToString()),
                // record.UniqueId is always there
                new EmailTag("[#recordUniqueId#]", record.UniqueId.ToString()),
            });   
